    ...
    return (
        <React.Fragment>
            <div className="inner">
                ...
                <div className="fold__body">
                    <div className="container-full">
                        <p>Link are used as navigational elements. They may appear on their own, within a sentence or
                            paragraph, or directly following the content.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="fold__body">
                ...
                <p>The Regular Links are the most common usage of the link style across the platform. In some Ccases, to
                    make them stand out. the links are in red (Special Links, Popup). Within tables, the link are
                    undefined while the highlighted email link appears as a button.</p>
            </div>
        </React.Fragment>
    );
};
