        ...
        <React.Fragment>
            <div className="inner">
                <div className="fold__header">
                    <h1>Cards</h1>
                    <p>Cards provide the possiblilty to display content composed of various smaller UI elements. On GO,
                        they are used to highlight key numbers and important information on emergencies</p>
                </div>
                <div className="fold__header">
            ...
            <div className="container-full">
                ...
                <p>The cards are used to highlight key numbers on top of the page, just below the main header. They can
                    vary depending on the page. Highlighted emergencies is a clickable card. While the pthers are just
                    informational.</p>
            </div>
