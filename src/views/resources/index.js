                                ...
                                <div className="about__resources__row row flex-mid">
                                    ...
                                    <div className="col col-4-mid">
                                        <div className="box__global box__global--resources">
                                            ...
                                            <div className="box__global__content">
                                                <p>This section outlines the specific UI components (such as headers,
                                                    navigation, forms, and others) that form IFRC GO. Each component
                                                    includes design and development specifications.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col col-4-mid">
                                        <div className="box__global box__global--resources">
                                            <div className="box__global__heading">
                                                <div className="base-font-semi-bold">Data Visualisations</div>
                                            </div>
                                            <div className="box__global__content">
